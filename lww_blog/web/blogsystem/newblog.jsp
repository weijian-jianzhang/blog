...
<div class="container">
    ...
    <form action="/blogServlet" onsubmit="return check();" class="form-x form-tips"><div class="form-group" id="f_1573264708381">
        <input type="hidden" name="cast" value="newblog"/>
        <div class="label">
            <label for="f_txt">
                博客标题
            </label>
        ...
        <div class="label">
            <%--@declare id="f_address_txt"--%><label for="f_address_txt">
                博客内容
            </label>
        </div>
        <div class="field">
